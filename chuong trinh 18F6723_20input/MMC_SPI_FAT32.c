...
#define SET_MMC_TRIS() set_tris_d(0x04) // 0b0001000 1=input,0=output 0100 0x00000010
// Change these pins to whatever pins you are using
#define ChipSel   pin_D0 // Chip-Select pin
#define ChipClk   pin_D3 // SPI-Clock pin
#define ChipDout  pin_D1 // SPI-Data out pin
#define ChipDin   pin_D2 // SPI-Data in pin
